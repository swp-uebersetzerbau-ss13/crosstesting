...
public class AddProgTest extends AbstractCrosstest {

	public AddProgTest(String testname, Class lexerToUse, Class parserToUse, Class analyserToUse, Class irgenToUse,
					   Class backToUse) {
