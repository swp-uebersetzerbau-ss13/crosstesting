...
public class MultiplePlusesInExpProgTest extends AbstractCrosstest {

	public MultiplePlusesInExpProgTest(String testname, Class lexerToUse, Class parserToUse, Class analyserToUse, Class irgenToUse,
									   Class backToUse) {
